      ...
      <form class="max-w-lg mx-auto">
        ...
        <div class="flex gap-2">
          ...
          <button
            ...
            class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200"
            type="button"
          >
            All categories
            <svg
          ...
          <button
            ...
            id="dropdown-button"
            data-dropdown-toggle="dropdown"
            class="flex-shrink-0 rounded-md z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300  hover:bg-gray-200"
            type="button"
          >
            Location
            <svg
...
export class HomeComponent {
  ...
  cardData = [
    ...
    {
      cardTitle: 'Recycling',
      cardDescription: 'Recycle waste and save the environment.',
      cardImage: 'recycle.png',
      cardLink: '/recycling',
    },
  ];
  locationData = [
